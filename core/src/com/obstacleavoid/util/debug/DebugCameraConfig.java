...
public class DebugCameraConfig {
    ...
    private static final int DEFAULT_KEY_ZOOM_IN = Input.Keys.I;
    private static final int DEFAULT_KEY_ZOOM_OUT = Input.Keys.O;
    ...
    private void load() {
        try {
            ...
            zoomInKey = getInputKeyValue(root, ZOOM_IN_KEY, DEFAULT_KEY_ZOOM_IN);
            zoomOutKey = getInputKeyValue(root, ZOOM_OUT_KEY, DEFAULT_KEY_ZOOM_OUT);
    ...
    private void setupDefaults() {
        ...
        zoomInKey = DEFAULT_KEY_ZOOM_IN;
        zoomOutKey = DEFAULT_KEY_ZOOM_OUT;
